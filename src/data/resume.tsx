...
export const DATA = {
  ...
  summary:
    "Passionate Mobile & Backend Developer, [I pursued a double degree in computer application and history](/#education), [Located in Kolkata](https://maps.app.goo.gl/Rk6w5sZuvpkhqmc98), Expert in crafting dynamic mobile experiences with Jetpack Compose for modern Android UI development. Skilled in building high-performance backend systems with Nest JS, Python FastAPI, and Rust",
  avatarUrl: "/me.png",
  skills: [
    "Flutter",
    "Dart",
